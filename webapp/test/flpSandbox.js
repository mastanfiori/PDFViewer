		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comnttdatacovercraftr126pdfview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttdatacovercraftr126pdfview-display": {
								"semanticObject": "comnttdatacovercraftr126pdfview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nttdata.covercraft.r126pdfview",
									"url": sap.ui.require.toUrl("com/nttdata/covercraft/r126pdfview")
								}
							}
						}
					}
